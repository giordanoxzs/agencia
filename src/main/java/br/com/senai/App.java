...
public class App 
{
    public static void main( String[] args ) {
        ...
        yasmin.nomeCompleto = "Yasmin Ferreira";
        yasmin.dataNascimento = LocalDate.of(2006, 7, 18);
        ...
        e1.dataInicio = LocalDate.of(2022, 02, 1);
        e1.dataFim = LocalDate.of(2023, 06, 10);

        Escolaridade e2 = new Escolaridade();
        e2.nomeCurso = "Direito";
        e2.nomeInstituicao = "UFPI";
